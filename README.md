...
3. **Add Environments variables to the project**
   ...
   ```shell
      ...
      OVERIGE_OBJECT_API_PORT="" # overige-object-api
      OVERIGE_OBJECT_API_CORS="" # overige-object-api Example value for more then one domain 'http://localhost:3000, http://localhost:3001'
   ```
