...
STRAPI_FRONTEND_URL=
STRAPI_BACKEND_URL=
STRAPI_UPLOAD_PROVIDER_HOSTNAME=
...
| `STRAPI_FRONTEND_URL`               |                                                                                                                                                                                                                                                                                     | `String`                      |                    | strapi-dashbaord frontend |                                                                                                                                                                                                                          |
| `STRAPI_BACKEND_URL`                |                                                                                                                                                                                                                                                                                     | `String`                      |                    | frontend                  |                                                                                                                                                                                                                          |
| `STRAPI_UPLOAD_PROVIDER_HOSTNAME`   |                                                                               [Allow optimize external images within Nextjs](https://nextjs.org/docs/api-reference/next/image#configuration-options)                                                                                | `String`                      |                    | frontend                  | For AWS S3 the URL should be based on this pattern `${env('AWS_BUCKET')}.s3.${env('AWS_REGION')}.amazonaws.com`                                                                                                          |
