...
export interface paths {
    "/objects": {
        ...
        /** List all objects (Kennisartikelen and VAC) or filter by type */
...
export interface operations {
    getObjects: {
        parameters: {
            query?: {
                type?: "http://localhost:4001/api/v1/objecttypes/kennisartikel" | "http://localhost:4001/api/v1/objecttypes/vac";
            };
            header?: never;
            path?: never;
            cookie?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["kennisartikel"][] | components["schemas"]["vac"][] | Record<string, never>[] | {
                        results?: (components["schemas"]["kennisartikel"] | components["schemas"]["vac"])[];
                    };
                };
            };
    ...
    getObjectById: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["kennisartikel"] | components["schemas"]["vac"];
                };
            };
            /** @description Forbidden */
            403: {
