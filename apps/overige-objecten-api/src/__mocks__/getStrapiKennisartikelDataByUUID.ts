export const getStrapiKennisartikelDataByUUID = () => {
  return {
    data: {
      products: [
        {
          id: 'l9ayhavxycg4w4dcqf2shjne',
          title: 'Demo Product',
          slug: 'demo-product',
              ...
              internal_field: {
                content: {
                  ...
                  contentBlock: [
                    ...
                    { content: '<h2>Inleiding - internal</h2><p>Body tekst</p>', kennisartikelCategorie: 'inleiding' },
                    { content: '<h2>Aanvraag - internal</h2><p>Body tekst</p>', kennisartikelCategorie: 'aanvraag' },
                    { content: '<h2>Bewijs - internal</h2><p>body tekst</p>', kennisartikelCategorie: 'bewijs' },
                    {
                      content: '<h2>Voorwaarden - internal</h2><p>body tekst</p>',
                      kennisartikelCategorie: 'voorwaarden',
                    },
                    { content: '<h2>Bezwaar - internal</h2><p>body tekst</p>', kennisartikelCategorie: 'bezwaar' },
                    { content: '<h2>Kosten - internal </h2><p>body tekst</p>', kennisartikelCategorie: 'kosten' },
                    { content: '<h2>Termijn - internal </h2><p>body tekst</p>', kennisartikelCategorie: 'termijn' },
                    {
