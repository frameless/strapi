...
import { buildAlternateLinks, buildURL, fetchData, getStrapiGraphqlURL } from '@/util';
  ...
  return (
    <html lang={locale} dir={dir(locale)} id="top" className="utrecht-scroll-to-top-container">
      ...
      >
        ...
        <MatomoTagManager nonce={nonce} strategy="beforeInteractive" src={matomoHost?.href} />
