    ...
    if (data && data.length > 0) {
        ...
        var meta = data.map(function (_a) {
            ...
            return {
                ...
                onlineAanvragen: (_m = attributes.catalogiMeta) === null || _m === void 0 ? void 0 : _m.onlineRequest.type,
        ...
        meta.forEach(function (item) {
            ...
            item.audiences.forEach(function (audience) {
                owmsmantel
                    ...
                    resourceIdentifier: "http://standaarden.overheid.nl/owms/terms/".concat(audience === null || audience === void 0 ? void 0 : audience.type.toLowerCase()),
                })
                    .txt(audience.type);
            });
