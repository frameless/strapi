                ...
                <LanguagesList
                  ...
                  selectField={{
                    placeholder: formatMessage({
                      id: 'components.languagesList.placeholder',
                      defaultMessage: 'Select a language',
                    }),
                    removeLanguageOption: formatMessage({ id: 'components.languagesList.removeLanguage' }),
                  }}
                />
              </Box>
            )}
            ...
            <IconButtonGroup className={classnames('button-group')}>
              ...
              <LinkDialog
                ...
                dialogTitle={formatMessage({
                  id: 'components.toolbar.linkDialog.title',
                  defaultMessage: 'Insert a URL link',
                })}
                textInputProps={{
                  label: formatMessage({
                    id: 'components.toolbar.linkDialog.textInput.label',
                    defaultMessage: 'Insert a URL link',
                  }),
                  placeholder: formatMessage({
                    id: 'components.toolbar.linkDialog.textInput.placeholder',
                  ...
                  ariaLabel: 'URL',
                  hint: formatMessage({
                    id: 'components.toolbar.linkDialog.textInput.hint',
                    defaultMessage:
                      "URLs should start with 'https://' or 'http://', for example: https://www.example.com or https://example.com",
                  }),
                  error: error
                    ? formatMessage({
                        id: 'components.toolbar.linkDialog.textInput.error',
                        defaultMessage:
                ...
                startActionButtonProps={{
                  ...
                  text: formatMessage({
                    id: 'components.toolbar.linkDialog.startActionButtonText',
                ...
                endActionButtonProps={{
                  ...
                  text: formatMessage({
                    id: 'components.toolbar.linkDialog.endActionButtonText',
